...
object Global {
    ...
    const val MESSAGE_LOG_FEATURE_TITLE = "Logs Unsent Messages"
    const val MESSAGE_LOG_FEATURE_DESC = "Any unsent messages will be saved."
    const val MESSAGE_LOG_FEATURE_EMPTY = "No deleted messages captured yet."
